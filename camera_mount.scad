...
thread_diameter = 12.35;	// Diameter of thread (M12) + extra for shrinking
thread_margin = 2;		// Thickness of ring around thread
thread_pitch = 0.5;		// Pitch of thread
mount_height = 12.0;	// Overall height of thread
...
enable_thread = false;	// Turn on/off thread (takes a while to render)
